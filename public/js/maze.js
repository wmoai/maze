  ...
  Chara.prototype.walk = function() {
    ...
    if (!this.end && this.x == this.goal.x && this.y == this.goal.y) {
      ...
      this.log('ゴール！<br>スコア：'+score
              + '<a href="https://twitter.com/share" class="twitter-share-button" data-text="モアイ迷宮を脱出 [score:'+score+']" data-count="none" data-hashtags="モアイ迷宮">Tweet</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document, "script", "twitter-wjs");</script>');
      this.end = true;
    }
  }
